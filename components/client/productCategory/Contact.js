...
const Contact = ({data}) => {
  ...
  //     autoplaySpeed: 10000,
  //     nextArrow:
  //       '<div class="right-arrow"><img src="images/next-arrow.png" alt="Arrow Right" width="16" height="auto"></div>',
  //     prevArrow:
  //       '<div class="left-arrow"><img src="images/prev-arrow.png" alt="Arrow Left" width="16" height="auto"></div>',
  //     responsive: [
  //       {
  //         breakpoint: 991,
  //         settings: {
                  ...
                  <div className="grid">
                    <div className="lg-6 sm-12">
                      <div className="testimonials-content">
                        ...
                        />
                        <p className="desc">
                          Madhur Co-Operative Hsg Society did avail of the
                          services by AWC for terrace waterproofing and
                          structural building repairs along with plastering and
                          external paints 3 years back. We are vey happy with
                          the results and the professionalism with which the
                          huge contract was executed in stipulated time! Thanks
                          to the entire team and Mr. Firoz for a job well-done!
                        </p>
                    ...
                    <div className="lg-6 sm-12">
                      <div className="testimonials-content">
                        ...
                        />
                        <p className="desc">
                          AWC is working with highly professional and
                          experienced engineers who have given value for money
                          for their products. They have carried out a good job
                          and have provided good solutions for the leakage
                          problem in our society. Thank you Firoz Sir, for the
                          excellent warranty service that is provided to us
